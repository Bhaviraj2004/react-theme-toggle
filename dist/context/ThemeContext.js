...
//         return 'dark';
//       case 'system':
//         // ✅ FIX: Properly check system preference
...
//     }
//   };
//   // ✅ FIX: Initialize mode from localStorage FIRST
//   const [mode, setMode] = useState<ThemeMode>(() => {
//     if (typeof window === 'undefined') return defaultMode;
//     const saved = localStorage.getItem('theme-mode') as ThemeMode;
//     return saved || defaultMode;
//   });
//   // ✅ FIX: Initialize theme based on the loaded mode
...
//   }, [mode]);
//   // ✅ FIX: Listen to system preference changes (for 'system' mode)
//   useEffect(() => {
...
//   }, [mode]);
//   // ✅ FIX: Auto mode - check every minute
//   useEffect(() => {
//     if (mode !== 'auto') return;
//     const checkTime = () => {
//       const hour = new Date().getHours();
...
//   }, [mode]);
//   return (
//     <ThemeContext.Provider value={{ theme, mode, setMode, slideDirection }}>
